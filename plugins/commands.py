...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            ...
            [
                InlineKeyboardButton('⚡ Subscribe ⚡', url=f"https://t.me/Blackharbour"),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ Subscribe ⚡', url='https://t.me/ZCipher'),
            InlineKeyboardButton('🤖 UᎮDΛTΞS 🤖', url='https://t.me/Blackharbour')
            ],[
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        await client.send_message(
            ...
            text="**Join our main channel to use this bot!**",
